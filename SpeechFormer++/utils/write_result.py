...
def path_to_csv(filepath='/data/eihw-gpu1/pechleba/SpeechFormer/SpeechFormer2/exp', criterion=['MSE'], evaluate=['MSE'], 
    largest=5, retrun=5, task='regression', logname='test.log', csvfile='test.csv', overwrite=False):
    '''
